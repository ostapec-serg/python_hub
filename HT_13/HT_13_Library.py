class Library(object):
    ...
    def library_menu(self):
        ...
        while flag:
            try:
                print(f"\nVisitor info, press - 1\n"
                      f"View amount visitors, press - 2\n"
                      f"View all available books, press - 3\n"
                      f"Choosing a book, press - 4\n"
                      f"Return book to the library - 5\n"
                      f"Reading selected books, press - 6\n"
                      f"View my books, press - 7\n"
                      f"Exit, press - 0\n")
                ...
                if 0 <= menu_item <= 7:
                    if menu_item == 1:
                        ...
                        while True:
                            for book, author in sorted(Library.__allBooks.items()):
                                print(f"| {book} -- {author} |")
                            choose_book = input(f"\nChoose book that"
                                                f" you wanna take "
                                                f"(name of book):\n"
                            ...
                            if choose_book == '0':
                                break
                            self.__choose_book(choose_book)
                            continue
                    elif menu_item == 5:
                        print(self.my_books)
                        book_to_return = input(f"What book you wanna return?"
                                               f"(name of book)\n")
                        self.__return_book(book_to_return)
                        continue
                    elif menu_item == 6:
                        if self.my_books != {}:
                            print(self.my_books)
                            book_to_read = input("What book do you "
                                                 "wanna read?:\n")
                            self.__reading(book_to_read)
                        else:
                            print("Your book list is empty\n"
                                  "select a book from the list of available\n"
                                  "(menu item 4)")
                        continue
                    elif menu_item == 7:
                        if self.my_books != {}:
                            for book, author in sorted(self.my_books.items()):
                                print(f"| {book} -- {author} |")
                        else:
                            print("Your book list is empty\n"
                                  "select a book from the list of available\n"
    ...
    def __visitor_info(self):
        ...
        """
        for value, info in self.__dict__.items():
            print(f" {value} -- {info}")
    ...
    def __view_visitors():
        ...
        """
        print(f"At this moment {Library.__visitors} "
              f"visitor(s) in library!")
    ...
    def __choose_book(self, choose_book):
        """
    ...
    def __return_book(self, book_to_return):
        """
            ...
            if book_to_return in self.my_books:
                ...
                for book, author in copy_my_book.items():
                    if book_to_return == book:
                        ...
                        self._amount_books -= 1
                        print(f"{self.name} return book {book} "
                              f"author {author}")
                        return {book: author}
            else:
                return
    ...
    def __reading(self, book_to_read):
        """
...
anna = Library('anna', 12345)
kevin = Library('kevin', 54321)
anna.library_menu()
kevin.library_menu()
anna.library_menu()
anna.library_menu()
print(anna.my_books)
print(kevin.my_books)
print(anna.name)
print(anna.my_books)
print(kevin.my_books)
...
def tables():
    try:
        with sqlite3.connect('bankom.db') as db:
            ...
            cursor.execute('''CREATE TABLE balance (id INTEGER, user TEXT, balance INTEGER, 
                            PRIMARY KEY("id" AUTOINCREMENT))''')

            cursor.execute(''' CREATE TABLE banknote ("id" INTEGER, "banknote" INTEGER,
                            amount INTEGER, PRIMARY KEY("id" AUTOINCREMENT)) ''')

            cursor.execute('''CREATE TABLE operation (id INTEGER, user TEXT, operation TEXT, 
                            status TEXT, amount INTEGER, PRIMARY KEY("id" AUTOINCREMENT))''')
